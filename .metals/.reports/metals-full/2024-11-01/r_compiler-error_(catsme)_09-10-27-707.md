file://<WORKSPACE>/src/main/scala/x/cats/ApplicativeStudy.scala
...
action parameters:
offset: 179
uri: file://<WORKSPACE>/src/main/scala/x/cats/ApplicativeStudy.scala
text:
```scala
package x.cats
...
object ApplicativeStudy {
	...
	val listApplicative = Applicative[]@@
